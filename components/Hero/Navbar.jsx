        ...
        >
          <ul
            className={`${scrollY > 10
                ...
                : "bg-white"
              } flex flex-col border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700`}
          >
            ...
            <li onClick={() => setActive(7)}>
              <a
                href="#contact"
                className={`block py-2 text-lg pl-3 pr-4 md:hover:border-b-4 rounded md:rounded-none dark:hover:bg-gray-900 dark:md:hover:bg-black md:bg-transparent ${active === 7
                    ? scrollY > 10
                      ? "text-white bg-blue-700 md:border-b-4"
                      : "md:text-blue-700 text-white bg-blue-700 md:border-b-4"
                    : scrollY > 10
